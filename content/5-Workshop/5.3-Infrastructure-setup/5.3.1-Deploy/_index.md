...
Source: [https://github.com/Aohk22/fcj-1-file-analyzer/tree/main](https://github.com/Aohk22/fcj-1-file-analyzer/tree/main)

## Deployment Steps

Run the Terraform workflow and Image Builder pipeline in order:
...
Create the Image Builder resources:
...
Script source, it polls the AWS api for status: 
